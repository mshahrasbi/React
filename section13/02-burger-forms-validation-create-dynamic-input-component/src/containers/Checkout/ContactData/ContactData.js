    ...
    render() {
        ...
        let form = (
            <form>
                ...
                <Input inputtype="input" type='text' name='street' placeholder='Your Address Street'/>
                <Input inputtype="input" type='text' name='postal' placeholder='Your Address Postal Code'/>
