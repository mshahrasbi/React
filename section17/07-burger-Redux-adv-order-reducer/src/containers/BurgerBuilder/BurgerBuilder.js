...
const mapDispatchToProps = dispatch => {
    return {
        onIngredeintAdded: (ingName) => dispatch(burgerBuilderActions.addIngredient(ingName)),
        onIngredeintRemoved: (ingName) => dispatch(burgerBuilderActions.removeIngredient(ingName)),
